...
(defun nCaixasFechadas (no cl &optional (iL 1)(posL 1)(iC 1)(posC 1)(caixas 0)(itNumber))
 (cond
  ((equal itNumber cl) counter)
  ((equal cl posC) (nCaixasFechadas no cl iL (+ posL 1) (+ iC 1) posC caixas (+ itNumber 1)))
  ...
  ((not (and (equal 1 (get-arco-na-posicao posL iL))(equal 1 (get-arco-na-posicao (+ 1 posL) iL))(equal 1 (get-arco-na-posicao posC iC))(equal 1 (get-arco-na-posicao (+ 1 posC) iC)))) (nCaixasFechadas no cl (+ iL 1) posL iC (+ posC 1) caixas itNumber))
 )
)